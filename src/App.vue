...
const states = reactive({
  todoList: [
    { id: 1, todo: "ES6학습", desc: "설명1", done: false, category: "Healing" },
    { id: 2, todo: "React학습", desc: "설명2", done: false, category: "Healing" },
    { id: 3, todo: "ContextAPI 학습", desc: "설명3", done: true, category: "Healing" },
    { id: 4, todo: "야구경기 관람", desc: "설명4", done: false, category: "Healing" },
  ]
});
